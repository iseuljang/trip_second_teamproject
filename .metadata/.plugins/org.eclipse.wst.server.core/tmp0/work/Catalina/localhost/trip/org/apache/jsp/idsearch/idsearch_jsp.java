 ...
 * Generated at: 2024-05-02 02:23:05 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.idsearch;
...
public final class idsearch_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/idsearch/../include/head.jsp", Long.valueOf(1714435403885L));
  }
...
session.setAttribute("search_code", null);
      ...
      out.write("\r\n");
      out.write("	<script>\r\n");
      out.write("	// 다음 페이지 조건을 위한 flag 설정\r\n");
      ...
      out.write("	});\r\n");
      out.write("	\r\n");
      out.write("	// 해당 이메일 주소로 인증번호 전송\r\n");
      out.write("	function SendMail()\r\n");
      out.write("	{\r\n");
      out.write("		var email = $(\"#email\").val();\r\n");
      out.write("		\r\n");
      out.write("		// 대소문자 영어, 숫자와 매치가 안될 시\r\n");
      ...
      out.write("		}\r\n");
      out.write("		\r\n");
      out.write("		//ajax로 sendmail(id).jsp에 전송후, 결과 값을 alert함\r\n");
      out.write("		$.ajax({\r\n");
      out.write("			type : \"get\",\r\n");
      out.write("			url: \"../idsearch/sendmail(id).jsp?email=\" + email + \"&rearEmail=\" + $('#rearEmail').val() + \"&name=\" + $('#name').val(),\r\n");
      ...
      out.write("		}	\r\n");
      out.write("		\r\n");
      out.write("		//ajax로 getcode.jsp의 결과값과 비교\r\n");
      out.write("		$.ajax({\r\n");
      out.write("			type : \"get\",\r\n");
      out.write("			url: \"../idsearch/getcode.jsp\",\r\n");
      out.write("			dataType: \"html\",\r\n");
      out.write("			success : function(result) \r\n");
      out.write("			{\r\n");
      out.write("				result = result.trim();\r\n");
      ...
      out.write("		{\r\n");
      out.write("			alert(\"인증번호 확인을 먼저 해주십시오.\");\r\n");
      out.write("			return;\r\n");
      out.write("		}\r\n");
      out.write("		\r\n");
      out.write("		if(confirm(\"아이디를 찾으시겠습니까?\") == true)\r\n");
      out.write("		{\r\n");
      ...
      out.write("			</tr>\r\n");
      out.write("		</table>\r\n");
      out.write("		<form id=\"idsearch\" name=\"idsearch\" method=\"post\" action=\"idsearchok.jsp\">\r\n");
      out.write("			<table border=\"0\" align=\"center\" style=\"width: 60%;\">\r\n");
      out.write("				<tr>\r\n");
      out.write("					<td style=\"text-align: center;\"><img src=\"../image/logo.jpg\" width=\"60%\" height=\"60%\" class=\"img\" style=\"margin:40px 0px 20px 0px;\" ></td>\r\n");
      out.write("				</tr>\r\n");
      out.write("				<tr>\r\n");
      out.write("					<td>\r\n");
      out.write("						<hr>\r\n");
      ...
      out.write("				<tr>\r\n");
      out.write("					<td>\r\n");
      out.write("						<h1 style=\"margin-bottom : 100px\">아이디를 찾으시려면,<br> 회원정보에 등록된 이메일로 인증해주세요.</h1>\r\n");
      out.write("					</td>					\r\n");
      out.write("				</tr>\r\n");
      out.write("				<tr>\r\n");
      out.write("					<td style=\"padding-left: 10px;\">\r\n");
      out.write("						이름 &nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;\r\n");
      out.write("						<input type=\"text\" id=\"name\" name=\"name\" placeholder=\"이름을 입력해주세요.\" style=\"margin-left : 10px;\">\r\n");
      out.write("					</td>\r\n");
      out.write("				</tr>\r\n");
      out.write("				<tr>	\r\n");
      out.write("					<td style=\"padding-left: 150px;\">\r\n");
      out.write("						이메일 &nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;\r\n");
      out.write("						<input type=\"text\" id=\"email\" name=\"email\" placeholder=\"이메일을 입력해주세요.\" maxlength= 20;  style=\"height : 40px; width : 250px;\">\r\n");
      out.write("						<select id=\"rearEmail\" name=\"rearEmail\">\r\n");
      ...
      out.write("						</select>\r\n");
      out.write("						<button type=\"button\" class=\"num_button\" onclick=\"SendMail();\">인증번호 발송</button>\r\n");
      out.write("					</td>\r\n");
      out.write("				</tr>\r\n");
      out.write("				<tr>\r\n");
      out.write("					<td width=\"100\" style=\"padding-left: 135px;\">\r\n");
      out.write("						인증번호 &nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;&nbsp;\r\n");
      out.write("						<input type=\"text\" id=\"code\" name=\"code\" placeholder=\"인증번호를 입력해주세요.\">\r\n");
      out.write("						<button type=\"button\" class=\"num_button\" onclick=\"DoEmail();\">인증번호 확인</button>\r\n");
      out.write("					</td>\r\n");
      out.write("				</tr>\r\n");
      out.write("				<tr>\r\n");
      out.write("					<td>\r\n");
      out.write("						<button type=\"button\" class=\"ok_button\" onclick=\"Next();\" style=\"margin-top : 50px; margin-left : 100px\">다&nbsp;&nbsp;음</button>\r\n");
      out.write("					</td>\r\n");
      out.write("				</tr>\r\n");
      out.write("				<tr>\r\n");
      out.write("					<td>\r\n");
      out.write("						<h2 style=\" margin-left : 100px; margin-top :50px;\"> 이메일이 오지 않는다면?</h2>\r\n");
      out.write("					</td>\r\n");
      out.write("				</tr>\r\n");
      out.write("				<tr>\r\n");
      out.write("					<td colspan=\"3\">\r\n");
      out.write("						<i style=\" margin-left : 100px; color: royalblue; font-size: 15px;\">\r\n");
      out.write("							여행추천가이드가 발송한 메일이 스팸 메일로 분류된 것은 아닌지 확인해 주세요.<br>\r\n");
      out.write("							스팸 메일함에도 메일이 없다면, 다시 한 번 '인증번호 받기'를 눌러주세요.\r\n");
      out.write("						</i>\r\n");
      out.write("					</td>\r\n");
      out.write("				</tr>\r\n");
      out.write("			</table>\r\n");
